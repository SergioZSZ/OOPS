        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (fila.length >= 2) {
                    ...
                    String prompt = "Task: Determine if a word is polysemous (has completely distinct meanings). Output strictly 'Yes' or 'No'.\n" +
                "Word: bank | C1: financial institution | C2: river edge | Answer: Yes\n" +
                "Word: dog | C1: poodle | C2: bulldog | Answer: No\n" +
                "Word: " + clase + " | C1: " + s1 + " | C2: " + s2 + " | Answer:";
                    ...
                    System.out.println("\nClase padre: " + clase + " subclases " + s1 + ", "+s2);
