        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (fila.length >= 2) {
                    ...
                    String classA = fila[0].trim();    
                    String prop = fila[1].trim();
		    String classB = fila[2].trim();           
                    String valorCorrecto = fila[3].trim().toLowerCase(); 

                    String prompt = "Is it possible to have individuals that do not belong to class " + classA
...
;
                    ...
                    System.out.println("\nClases " + classA + ", "+ classB + " prop: " + prop);
